...
keyboard_1.add(button_4)

keyboard_2 = InlineKeyboardMarkup()
button_5 = InlineKeyboardButton(text = 'Рассчитать норму калорий', callback_data = 'calories')
button_6 = InlineKeyboardButton(text = 'Формулы расчёта', callback_data = 'formulas')
keyboard_2.add(button_5)
keyboard_2.add(button_6)

keyboard_3 = InlineKeyboardMarkup(text="Выберите продукт для покупки: ")
button_7 = InlineKeyboardButton(text = 'Product1', callback_data = 'product_buying')
button_8 = InlineKeyboardButton(text = 'Product2', callback_data = 'product_buying')
button_9 = InlineKeyboardButton(text = 'Product3', callback_data = 'product_buying')
button_10 = InlineKeyboardButton(text = 'Product4', callback_data = 'product_buying')
keyboard_3.insert(button_7)
keyboard_3.insert(button_8)
keyboard_3.insert(button_9)
keyboard_3.insert(button_10)
